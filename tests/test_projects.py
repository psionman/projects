...
@pytest.mark.parametrize(
    "test_id, source_dir, cached_envs, expected",
    [
        (
            "HP_01",
            "/path/to/project",
            {},
            {"dir": "/path/to/project", "cached_envs": {}},
        ),
        (
            "HP_02",
            "/another/path",
            {"env1": MockSerialize("env1_data")},
            {"dir": "/another/path", "cached_envs": {"env1": "env1_data"}},
        ),
...
def test_serialize_happy_path(test_id, source_dir, cached_envs, expected):
    ...
    assert result == expected, (
        f"Failed {test_id}: Expected {expected}, got {result}"
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "/path/to/project",
            {"env1": MockSerialize("")},
            {"dir": "/path/to/project", "cached_envs": {"env1": ""}},
        ),
